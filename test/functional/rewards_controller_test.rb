...
class RewardsControllerTest < ActionController::TestCase
  ...
  test "should create reward" do
    assert_difference('Reward.count') do
      post :create, reward: { credit_cost: @reward.credit_cost, description: @reward.description, name: @reward.name }
    end
  ...
  test "should update reward" do
    put :update, id: @reward, reward: { credit_cost: @reward.credit_cost, description: @reward.description, name: @reward.name }
    assert_redirected_to reward_path(assigns(:reward))
  end
