...
class PointsControllerTest < ActionController::TestCase
  ...
  test "should create point" do
    assert_difference('Point.count') do
      post :create, point: { activity_id: @point.activity_id, points: @point.points, user_id: @point.user_id }
    end
  ...
  test "should update point" do
    put :update, id: @point, point: { activity_id: @point.activity_id, points: @point.points, user_id: @point.user_id }
    assert_redirected_to point_path(assigns(:point))
  end
